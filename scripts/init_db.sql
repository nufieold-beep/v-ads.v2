...
CREATE TABLE IF NOT EXISTS supply_tags (
    ...
    integration_type VARCHAR(16)  DEFAULT 'tag'  NOT NULL,
    pricing_type    VARCHAR(16)   DEFAULT 'floor' NOT NULL,
    bid_floor       DECIMAL(10,4) DEFAULT 0.0000 NOT NULL,
    margin_pct      DECIMAL(6,2)  DEFAULT 0.00   NOT NULL,
    revshare_pct    DECIMAL(6,2)  DEFAULT 80.00  NOT NULL,
    fixed_cpm       DECIMAL(10,4) DEFAULT 0.0000 NOT NULL,
    environment     INTEGER,
...
CREATE TABLE IF NOT EXISTS demand_endpoints (
    ...
    integration_type VARCHAR(16)   DEFAULT 'ortb' NOT NULL,
    bid_floor       DECIMAL(10,4)  DEFAULT 0.0000 NOT NULL,
    margin_pct      DECIMAL(6,2)   DEFAULT 0.00   NOT NULL,
    timeout_ms      INTEGER        DEFAULT 500    NOT NULL,
    qps_limit       INTEGER        DEFAULT 0      NOT NULL,
    ortb_version    VARCHAR(16)    DEFAULT '2.6'  NOT NULL,
    auction_type    INTEGER        DEFAULT 1      NOT NULL,
    mime_types      JSON,
    protocols       JSON,
    demand_type     VARCHAR(16)    DEFAULT 'video' NOT NULL,
    sensitive       BOOLEAN        DEFAULT FALSE  NOT NULL,
    regional_urls   JSON,
    status          INTEGER        DEFAULT 1      NOT NULL,
    created_at      TIMESTAMP      DEFAULT NOW()  NOT NULL,
